...
<div class="wrapper">
    <div class="sidebar" data-color="orange" data-image="<?= URL::to('/'); ?>/layout/assets/img/ngaji.jpg">
    ...
    <div class="main-panel">
        ...
        <!-- Content Disini -->
            <?php if(isset($profile_content)): ?>
                <?php if($profile_content != false): ?>
                    <?php echo $__env->make('content_profile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
            <?php else: ?>
                <?php echo $__env->make('content_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
        <!-- End Content -->
        ...
        function showNotif(idnotification) {
            ...
            $('#detailNotification').modal('toggle');
                ...
                $.ajax({
                    ...
                    data: { idnotification:idnotification, "_token": "<?php echo e(csrf_token()); ?>", },
...
<?php /**PATH X:\xampp\htdocs\siqur\resources\views/master.blade.php ENDPATH**/ ?>