...
$( document ).ready(function() {
	...
	$( "#print" ).click(function() {
		window.location.href = '<?php echo e(route("daily-report-print")); ?>'; 
	})
	...
	$( "#tampil" ).click(function() {
		...
		$.ajax({
		    type:'POST',
		    url: '<?php echo e(route("daily-report-show")); ?>',
		    data:{
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH X:\xampp\htdocs\siqur\resources\views/daily-report/index.blade.php ENDPATH**/ ?>